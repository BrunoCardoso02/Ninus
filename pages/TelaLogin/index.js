...
export default function TelaLogin() {
  const [email, setEmail] = useState('brunoteste@plusoft.com');
  const [senha, setSenha] = useState('Testandoplusoft1223');
    ...
    <ImageBackground source={require('../../assets/background.jpg')} style={{ height: "100%" }}>
      <ScrollView>
        ...
        <View style={styles.containerPrincipal}>
          ...
          <TouchableOpacity style={styles.textoCriarConta} onPress={SignIn}>
